...
export function getHtml({
  ...
  <html lang="pt-BR">
    <head>
      ...
      <meta name="twitter:image" content=${`https://youtube-serverless-thumb-generator-rho.vercel.app/api/thumbnail.png?level=${level}&challenges=${challenges}&experience=${experience}`}/>
